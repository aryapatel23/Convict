...
import "./Four_Month_internships.css";
...
const InternshipSearch = () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          const oneMonthInternships = data.filter(
            (internship) => internship.duration.toLowerCase() === "4 months"
          );
  ...
  return (
    <div className="internship-full-container">
      <h2 className="internship-heading">Search for 4-Months Internships</h2>
